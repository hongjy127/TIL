...
client_id = "4cf5f301c1c62029f447bb1326dea702"
...
class KakaoAuthView(TemplateView):
    ...
    def getAccessToken(self, code):
        ...
        payload += "&redirect_url=http%3A%2F%2F172.30.1.57%3A5000%2Foauth&code=" + code
        headers = {
    ...
    def save_access_token(self, access_token):
        with open("/home/pi/.access_token.txt", "w") as f:
